...
public class Service {
    ...
    public void addSubject(AbstractSubject[][] subjects, AbstractSubject subject) {
    ...
    public int deleteSubject(AbstractSubject[][] subjects, String name) {
        int flag = -1;
    ...
    public int[] findSubject(AbstractSubject[][] dimSubject, String name) {
        int[] m = new int[2];
        m[0] = -1;
        m[1] = -1;
        if (name != null) {
